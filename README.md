...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=20&pause=1000&color=378ADD&center=true&vCenter=true&width=480&lines=Data+Analyst;Business+Analyst;BI+Developer;SQL+%2B+Python+%2B+Dashboards" alt="Typing SVG" /></a>
...
My projects cover retail transactions, student behavior, and personal finance. Each one goes the full distance: SQL schema design, Python analysis, statistical testing, BI reporting, and a clear takeaway.
...
| :--- | :--- | :--- |
| [**🛒 Black Friday Sales Analysis**](https://github.com/Dipjyoti-Karmakar/black-friday-sales-analysis) | Python · SciPy · MySQL · Power BI | 550K+ transactions · Males aged 26-35 confirmed as key buyers |
| [**🗃️ Retail Sales & Customer DB**](https://github.com/Dipjyoti-Karmakar/retail-sales-sql-analytics) | MySQL · PostgreSQL · CTEs | Designed a normalized schema from scratch and built CTE-based analysis |
| [**☕ Coffee Retail Analytics**](https://github.com/Dipjyoti-Karmakar/coffee-sales-business-analytics) | Python · Pandas · Seaborn | Found 545 repeat buyers across 3,898 transactions; identified repeat-customer behavior |
| [**📱 Social Media Addiction Analysis**](https://github.com/Dipjyoti-Karmakar/social-media-addiction-analysis) | Python · Power BI | Built a rule-based risk classifier to segment students by addiction risk |
| [**💸 Flux — Personal Finance Dashboard**](https://github.com/Dipjyoti-Karmakar/flux-personal-finance-dashboard) | Vanilla JS · Firebase · PWA | Offline-capable budget tracker built as a single-page app |
| [**🤖 Dossier.ai**](https://github.com/Dipjyoti-Karmakar/dossier.ai) | Gemini API · GitHub API · Chart.js | Paste any GitHub username, get a structured developer profile report generated by Gemini |
...
Prospecting and pipeline work using data-driven targeting. The role sits at the intersection of sales ops and analysis.
...
- **B.Com** · *Jun 2025*
- **Data Analytics with GenAI** · Career247 · *Mar 2026* · [View Certificate](https://career247.edmingle.com/verify/C2472558)
